...
# 4.a aetherdz-tools (bash/files/web) — port of TS tools/
...
# 4.b aetherdz-agent (registry/router/executor) — port TS agents/ (4 files)
...
# 4.c aetherdz-auth (device flow/cache/fallback) — port TS auth/ (3 files)
...
# 4.d aetherdz-tui (ratatui full) — the visible upgrade over Ink TUI
