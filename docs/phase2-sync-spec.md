# Phase 2 — aether-sync: THE FLAGSHIP — Ready-to-fire spec
...
- Blueprint §4 (aether-sync crate), §2.2 item 4, §10 CLI: `aether sync setup gist|folder / push / pull / status`.
